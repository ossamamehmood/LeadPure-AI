        ...
        <motion.div variants={{ hidden: { opacity: 0, y: 20 }, show: { opacity: 1, y: 0 } }}>
          <GlossyCard className="p-7 rounded-[40px] shadow-2xl relative border-app-border bg-app-card overflow-hidden group hover:border-white/10 transition-all">
            ...
            <div className="mt-6 flex items-center justify-between">
              ...
              <div className="px-3 py-1 bg-gradient-to-r from-brand-blue/20 to-brand-purple/20 text-brand-blue text-[8px] font-black rounded-full uppercase tracking-widest border border-brand-blue/30 shadow-[0_0_10px_rgba(90,92,255,0.1)]">v10.5.5 Release</div>
            </div>
          </GlossyCard>
        </motion.div>
      </motion.div>
